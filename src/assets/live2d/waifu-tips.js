 ...
 */
import tipsConfig from './waifu-tips-config'
...
export function initWidget(config, apiPath) {
...
function move() {
	...
	let isRedayMove = false // 标识是否需要移动位置
	let l, t
	...
	document.addEventListener('mousemove', (e) => {
		if (!isRedayMove) return
		// live2d的宽高
		const { offsetWidth, offsetHeight } = waifu
		// 鼠标坐标
